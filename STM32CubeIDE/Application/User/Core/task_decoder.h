...
/* Raw EVT2.0 DMA buffer access for USB streaming */
#define EVT_BUF_LEN  (2048*4)   /* must match TX_SIZE in task_decoder.c */
extern uint32_t event_buffer[EVT_BUF_LEN];
extern uint32_t dcmi_dma_write_idx(const args_evt_decoder_t *args);
